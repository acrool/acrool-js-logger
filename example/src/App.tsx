...
function App() {
    ...
    return (
        <div className="App">
            <a href="https://github.com/acrool/acrool-js-logger" target="_blank" rel="noopener noreferrer">
            ...
            <div style={{textAlign: 'center', border: '1px solid #606060', display: 'flex', flexDirection: 'column', padding: '20px', margin: '20px 0'}}>
                ...
                <div style={{fontSize: '40px', color: '#fff', fontWeight: 700}}>Acrool JS Logger</div>
            </div>
