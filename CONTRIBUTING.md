...
- Create an [issue](https://github.com/acrool/acrool-js-logger/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/acrool/acrool-js-logger/issues), assuming one does not already exist.
